...
public class Latihan2 {
    ...
    public void formInputDept(String dept) {
        By inputDept = By.xpath("//input[@id='department']");
        wait.until(ExpectedConditions.elementToBeClickable(inputDept)).sendKeys(dept);
    }
